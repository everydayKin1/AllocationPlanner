  ...
  months: [
    {
      ...
      stages: [
        { id: "act-1", name: "第1幕", reward: 90, enemyOptions: [
          ...
          { name: "ヴィシャップ・岩×1、ヴィシャップ・水×1", icon: "岩", note: "過負荷などで怯ませられる", image: "./images/enemy/ヴィシャップ・岩.webp",  element: ["炎", "雷"] },
    ...
    },
    {
      ...
      stages: [
        ...
        { id: "act-2", name: "第2幕", reward: 90, enemy: { name: "8月サンプル2", icon: "風", note: "" } },
        { id: "act-3", name: "第3幕", reward: 125, enemy: { name: "8月サンプル3", icon: "岩", note: "第3幕報酬は+125。" } },
        { id: "act-4", name: "第4幕", reward: 90, enemy: { name: "8月サンプル4", icon: "剣", note: "" } },
        { id: "act-5", name: "第5幕", reward: 90, enemy: { name: "8月サンプル5", icon: "盾", note: "" } },
        { id: "act-6", name: "第6幕", reward: 125, enemy: { name: "8月サンプル6", icon: "双", note: "第6幕報酬は+125。" } },
        { id: "act-7", name: "第7幕", reward: 90, enemy: { name: "8月サンプル7", icon: "旗", note: "" } },
        { id: "act-8", name: "第8幕", reward: 125, enemy: { name: "8月サンプル8", icon: "鎧", note: "第8幕報酬は+125。" } },
        { id: "act-9", name: "第9幕", reward: 90, enemy: { name: "8月サンプル9", icon: "星", note: "" } },
