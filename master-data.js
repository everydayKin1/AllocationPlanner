window.GENGEKI_MASTER_DATA = {
  ...
  characters: [
    ...
    { id: "dehya", name: "ディシア", element: "炎", level: 90, image: "./images/character/Dehya_icon.webp", tags: { positions: ["オフフィールド"], roles: ["アタッカー", "ライフキーパー", "タンク"], weapon: "両手剣", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "chevreuse", name: "シュヴルーズ", element: "炎", level: 90, image: "./images/character/Chevreuse_icon.webp", tags: { positions: ["オフフィールド"], roles: ["サポーター", "ライフキーパー", "ヒーラー"], weapon: "長柄武器", nightsoul: false, pneumaOusia: "ウーシア", lunar: false, magic: false } },
    { id: "thoma", name: "トーマ", element: "炎", level: 90, image: "./images/character/Thoma_icon.webp", tags: { positions: ["オフフィールド"], roles: ["ライフキーパー", "シールダー"], weapon: "長柄武器", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "xinyan", name: "辛炎", element: "炎", level: 90, image: "./images/character/Xinyan_icon.webp", tags: { positions: ["オフフィールド"], roles: ["ライフキーパー", "シールダー"], weapon: "両手剣", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    { id: "bennett", name: "ベネット", element: "炎", level: 90, image: "./images/character/Bennett_icon.webp", tags: { positions: ["オフフィールド"], roles: ["サポーター", "ライフキーパー", "ヒーラー"], weapon: "片手剣", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "nicole", name: "ニコ", element: "炎", level: 90, image: "./images/character/Nicole_icon.webp", tags: { positions: ["オフフィールド"], roles: ["サポーター", "ライフキーパー", "シールダー"], weapon: "法器", nightsoul: false, pneumaOusia: "", lunar: false, magic: true } },
    ...
    { id: "sigewinne", name: "シグウィン", element: "水", level: 90, image: "./images/character/Sigewinne_icon.webp", tags: { positions: ["オフフィールド"], roles: ["サポーター", "ライフキーパー", "ヒーラー"], weapon: "弓", nightsoul: false, pneumaOusia: "ウーシア", lunar: false, magic: false } },
    { id: "furina", name: "フリーナ", element: "水", level: 90, image: "./images/character/Furina_icon.webp", tags: { positions: ["オフフィールド"], roles: ["アタッカー", "サポーター", "ライフキーパー", "ヒーラー"], weapon: "片手剣", nightsoul: false, pneumaOusia: ["プネウマ", "ウーシア"], lunar: false, magic: false } },
    ...
    { id: "sangonomiyakokomi", name: "珊瑚宮心海", element: "水", level: 90, image: "./images/character/SangonomiyaKokomi_icon.webp", tags: { positions: ["オフフィールド"], roles: ["サポーター", "ライフキーパー", "ヒーラー"], weapon: "法器", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "aino", name: "アイノ", element: "水", level: 90, image: "./images/character/Aino_icon.webp", tags: { positions: ["オフフィールド"], roles: ["アタッカー"], weapon: "両手剣", nightsoul: false, pneumaOusia: "", lunar: true, magic: false } },
    { id: "dahlia", name: "ダリア", element: "水", level: 90, image: "./images/character/Dahlia_icon.webp", tags: { positions: ["オフフィールド"], roles: ["ライフキーパー", "シールダー"], weapon: "片手剣", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "barbara", name: "バーバラ", element: "水", level: 90, image: "./images/character/Barbara_icon.webp", tags: { positions: ["オフフィールド"], roles: ["ライフキーパー", "ヒーラー"], weapon: "法器", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "qiqi", name: "七七", element: "氷", level: 90, image: "./images/character/Qiqi_icon.webp", tags: { positions: ["オフフィールド"], roles: ["ライフキーパー", "ヒーラー"], weapon: "片手剣", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "layla", name: "レイラ", element: "氷", level: 90, image: "./images/character/Layla_icon.webp", tags: { positions: ["オフフィールド"], roles: ["ライフキーパー", "シールダー"], weapon: "片手剣", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "mika", name: "ミカ", element: "氷", level: 90, image: "./images/character/Mika_icon.webp", tags: { positions: ["オフフィールド"], roles: ["サポーター", "ライフキーパー", "ヒーラー"], weapon: "長柄武器", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "diona", name: "ディオナ", element: "氷", level: 90, image: "./images/character/Diona_icon.webp", tags: { positions: ["オフフィールド"], roles: ["ライフキーパー", "ヒーラー", "シールダー"], weapon: "弓", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "charlotte", name: "シャルロット", element: "氷", level: 90, image: "./images/character/Charlotte_icon.webp", tags: { positions: ["オフフィールド"], roles: ["ライフキーパー", "ヒーラー"], weapon: "法器", nightsoul: false, pneumaOusia: "プネウマ", lunar: false, magic: false } },
    { id: "citlali", name: "シトラリ", element: "氷", level: 90, image: "./images/character/Citlali_icon.webp", tags: { positions: ["オフフィールド"], roles: ["サポーター", "ライフキーパー", "シールダー"], weapon: "法器", nightsoul: true, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "escofier", name: "エスコフィエ", element: "氷", level: 90, image: "./images/character/Escofier_icon.webp", tags: { positions: ["オフフィールド"], roles: ["アタッカー", "サポーター", "ライフキーパー", "ヒーラー"], weapon: "長柄武器", nightsoul: false, pneumaOusia: "ウーシア", lunar: false, magic: false } },
    ...
    { id: "ineffa", name: "イネファ", element: "雷", level: 90, image: "./images/character/Ineffa_icon.webp", tags: { positions: ["オフフィールド"], roles: ["アタッカー", "ライフキーパー", "シールダー"], weapon: "長柄武器", nightsoul: false, pneumaOusia: "", lunar: true, magic: false } },
    ...
    { id: "iansan", name: "イアンサ", element: "雷", level: 90, image: "./images/character/Iansan_icon.webp", tags: { positions: ["オフフィールド"], roles: ["サポーター", "ライフキーパー", "ヒーラー"], weapon: "長柄武器", nightsoul: true, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "dori", name: "ドリー", element: "雷", level: 90, image: "./images/character/Dori_icon.webp", tags: { positions: ["オフフィールド"], roles: ["ライフキーパー", "ヒーラー"], weapon: "両手剣", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    { id: "kukishinobu", name: "久岐忍", element: "雷", level: 90, image: "./images/character/KukiShinobu_icon.webp", tags: { positions: ["オフフィールド"], roles: ["ライフキーパー", "ヒーラー"], weapon: "片手剣", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "yumemizukimizuki", name: "夢見月瑞希", element: "風", level: 90, image: "./images/character/YumemizukiMizuki_icon.webp", tags: { positions: ["オンフィールド"], roles: ["アタッカー", "ライフキーパー", "ヒーラー"], weapon: "法器", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "xianyun", name: "閑雲", element: "風", level: 90, image: "./images/character/Xianyun_icon.webp", tags: { positions: ["オフフィールド"], roles: ["サポーター", "ライフキーパー", "ヒーラー"], weapon: "法器", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "jean", name: "ジン", element: "風", level: 90, image: "./images/character/Jean_icon.webp", tags: { positions: ["オフフィールド"], roles: ["ライフキーパー", "ヒーラー"], weapon: "片手剣", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    { id: "jahoda", name: "ヤフォダ", element: "風", level: 90, image: "./images/character/Jahoda_icon.webp", tags: { positions: ["オフフィールド"], roles: ["サポーター", "ライフキーパー", "ヒーラー"], weapon: "弓", nightsoul: false, pneumaOusia: "", lunar: true, magic: false } },
    { id: "ifa", name: "イファ", element: "風", level: 90, image: "./images/character/Ifa_icon.webp", tags: { positions: ["オンフィールド"], roles: ["サポーター", "ライフキーパー", "ヒーラー"], weapon: "法器", nightsoul: true, pneumaOusia: "", lunar: false, magic: false } },
    { id: "lanyan", name: "藍硯", element: "風", level: 90, image: "./images/character/LanYan_icon.webp", tags: { positions: ["オフフィールド"], roles: ["アタッカー", "ライフキーパー", "シールダー"], weapon: "法器", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "sayu", name: "早柚", element: "風", level: 90, image: "./images/character/Sayu_icon.webp", tags: { positions: ["オフフィールド"], roles: ["ライフキーパー", "ヒーラー"], weapon: "両手剣", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "linnea", name: "リンネア", element: "岩", level: 90, image: "./images/character/Linnea_icon.webp", tags: { positions: ["オフフィールド"], roles: ["アタッカー", "サポーター", "ライフキーパー", "ヒーラー"], weapon: "弓", nightsoul: false, pneumaOusia: "", lunar: true, magic: false } },
    ...
    { id: "xilonen", name: "シロネン", element: "岩", level: 90, image: "./images/character/Xilonen_icon.webp", tags: { positions: ["オフフィールド"], roles: ["サポーター", "ライフキーパー", "ヒーラー"], weapon: "片手剣", nightsoul: true, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "zhongli", name: "鍾離", element: "岩", level: 90, image: "./images/character/Zhongli_icon.webp", tags: { positions: ["オフフィールド"], roles: ["サポーター", "ライフキーパー", "シールダー"], weapon: "長柄武器", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "noelle", name: "ノエル", element: "岩", level: 90, image: "./images/character/Noelle_icon.webp", tags: { positions: ["オンフィールド"], roles: ["アタッカー", "ライフキーパー", "ヒーラー", "シールダー"], weapon: "両手剣", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "baizhu", name: "白朮", element: "草", level: 90, image: "./images/character/Baizhu_icon.webp", tags: { positions: ["オフフィールド"], roles: ["サポーター", "ライフキーパー", "ヒーラー"], weapon: "法器", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "kirara", name: "綺良々", element: "草", level: 90, image: "./images/character/Kirara_icon.webp", tags: { positions: ["オフフィールド"], roles: ["ライフキーパー", "シールダー"], weapon: "片手剣", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "alyosha", name: "アリョーシャ", element: "雷", level: 90, image: "./images/character/Alyosha_icon.webp", tags: { positions: ["オフフィールド"], roles: ["サポーター", "ライフキーパー", "ヒーラー"], weapon: "長柄武器", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
    ...
    { id: "yaoyao", name: "ヨォーヨ", element: "草", level: 90, image: "./images/character/Yaoyao_icon.webp", tags: { positions: ["オフフィールド"], roles: ["ライフキーパー", "ヒーラー"], weapon: "長柄武器", nightsoul: false, pneumaOusia: "", lunar: false, magic: false } },
